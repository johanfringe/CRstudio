...
const LanguageSwitcher = () => {
  ...
  return (
    <div className="relative" ref={langMenuRef}>
      ...
      <button
        className="flex items-center justify-center w-full text-sm text-gray-800 hover:text-black focus:outline-none"
        aria-haspopup="true"
      ...
      {isOpen && (
        <div
          className="absolute left-0 mt-2 bg-white shadow-lg rounded-md w-28"
          role="menu"
        ...
        >
          {languages.map((lang) => (
            <button
              ...
              className={`block px-4 py-1 w-full text-left text-sm ${
