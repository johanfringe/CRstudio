...
describe('validateSubdomain()', () => {
  ...
  test('⚠️ Alleen verwachte foutcodes worden geretourneerd', () => {
    ...
    const inputs = [
      '', 'ab', 'abc def', '---', 'a--b', 'kunstenaars', 'admin', 'valid-sub',
      'a'.repeat(64), 'valid123', '-start', 'end-', 'abc@de', 'über', 'emoji😀'
    ];
  ...
  test('🧪 Crasht niet bij random input', () => {
    const fuzz = [
      '8v6v0kv4e9', '5qrtqfv*4&-', 'z😀gv*g65ü5ki', 'd-6p47x1@aü*d', 'slq68i#^97_üy@',
      'vq41ä😀k%d*af_av', '-ü_%vold9ft*ül2n', 'fy90q6%w ne8nv&äl', 'wj1n*g%@e@&üdnr55*',
      'iv@😀q%tt0iy5!-! &07', '😀ny&fv&hhav4210ü&ä o', '-@364k790u%uvz77e0i@ ',
      '7qw_7-rj@ii_loa5n7jsi7', '7@y3^jw8 ö^äfu!r^&6o__e', '!näw*@oaxo#😀p9cr-1-^nxw#',
      '90zü6m3e_h77r9y16@😀8😀a 5_', 'v6😀pqms*%4😀2nüoe5#n_-yn3y2',
      'ttärd7sh^jcq2gy%n*😀zä%hc!lc', 'r7 fm-7!2pd@ig9x1wn*-ün@lüu7',
