...
// Check of e-mailadres al in temp_users staat
...
export default async function handler(req, res) {
  ...
  const redisKey = `register:${ip}`;
    ...
    // ✅ Supabase: bestaat email al in auth.users?
    ...
    // 🔑 Token genereren en gebruiker opslaan in temp_users
    ...
    // 📧 Verificatie e-mail samenstellen en verzenden
    ...
    log("✅ Verificati-email succesvol verzonden", { email });
