// src/api/sendVerificationEmail.js :
...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("📩 Verificatiemail aanvraag voor:", email);

    // 🛑 **Rate limiting met Redis**
    const redisKey = `sendVerification:${email}`;
    ...
    // ✅ **Update de database met verificatietoken**
    ...
    console.log("✅ Verificatietoken gegenereerd:", verificationToken);

    // 📧 **Verificatiemail verzenden via Postmark**
    ...
    console.error("❌ Fout bij het verzenden van verificatiemail:", error);
