var plugins = [{
      ...
      options: {"plugins":[],"localeJsonSourceName":"locales","languages":["en","fr","nl","zu"],"defaultLanguage":"zu","siteUrl":"http://localhost:8000","i18nextOptions":{"interpolation":{"escapeValue":false},"detection":{"order":["path","htmlTag","cookie","navigator"],"caches":["cookie"]},"fallbackLng":"zu","backend":{"loadPath":"/Users/johan/CRstudio/CRstudio/src/locales/{{lng}}/{{ns}}.json"}},"pages":[{"matchPath":"/:lang/:rest*","getLanguageFromPath":true}]},
    },{
