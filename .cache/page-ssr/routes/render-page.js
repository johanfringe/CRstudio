...
var React = _interopRequireWildcard(__webpack_require__(1799));
...
var _scrollHandler = __webpack_require__(3215);
var _react = __webpack_require__(1799);
...
var _react = _interopRequireDefault(__webpack_require__(1799));
...
exports.components={"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 125).then(__webpack_require__.bind(__webpack_require__, 3331)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 293).then(__webpack_require__.bind(__webpack_require__, 8017))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-image',plugin:__webpack_require__(70),options:{"plugins":[]}},{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(6560),options:{"plugins":[]}},{name:'gatsby-plugin-react-i18next',plugin:__webpack_require__(313),options:{"plugins":[],"localeJsonSourceName":"locales","languages":["en","fr","nl","zu"],"defaultLanguage":"zu","siteUrl":"https://crstudio.online","i18nextOptions":{"interpolation":{"escapeValue":false},"detection":{"order":["path","htmlTag","cookie","navigator"],"caches":["cookie"]},"fallbackLng":"zu","backend":{"loadPath":"/Users/johan/CRstudio/CRstudio/src/locales/{{lng}}/{{ns}}.json"}},"pages":[{"matchPath":"/:lang/:rest*","getLanguageFromPath":true}]}},{name:'gatsby-plugin-sitemap',plugin:__webpack_require__(9672),options:{"plugins":[],"output":"/sitemap.xml","excludes":["/admin/*","/drafts/*","/preview/*","/private/*"],"createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }"}},{name:'gatsby-plugin-manifest',plugin:__webpack_require__(4858),options:{"plugins":[],"name":"Catalogue Raisonné","short_name":"CR","start_url":"/","background_color":"#ffffff","theme_color":"#663399","display":"standalone","icon":"static/icons/favicon-512x512.png","legacy":true,"theme_color_in_head":true,"cache_busting_mode":"query","crossOrigin":"anonymous","include_favicon":true,"cacheDigest":"25fcdfc9b3ec1ab58885bcc31da4342e"}},{name:'partytown',plugin:__webpack_require__(387),options:{"plugins":[]}}];/* global plugins */// During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1799);
...
const React=__webpack_require__(1799);const{grabMatchParams}=__webpack_require__(5870);const{StaticQueryContext}=__webpack_require__(123);const{headExportValidator,filterHeadProps,isElementType,isValidNodeName,warnForInvalidTag}=__webpack_require__(9226);const{ServerLocation,Router}=__webpack_require__(6462);const{renderToString}=__webpack_require__(8279);const{parse}=__webpack_require__(6192);const styleToOjbect=__webpack_require__(9108);function applyHtmlAndBodyAttributesSSR(htmlAndBodyAttributes,{setHtmlAttributes,setBodyAttributes}){if(!htmlAndBodyAttributes)return;const{html,body}=htmlAndBodyAttributes;setHtmlAttributes(html);setBodyAttributes(body);}function getValidHeadNodesAndAttributesSSR(rootNode,htmlAndBodyAttributes={html:{},body:{}}){const seenIds=new Map();const validHeadNodes=[];// Filter out non-element nodes before looping since we don't care about them
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);var React=_interopRequireWildcard(__webpack_require__(1799));var _gatsby=__webpack_require__(123);var _common=__webpack_require__(1854);var _getManifestPathname=_interopRequireDefault(__webpack_require__(4598));function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: remove for v3
...
"use strict";
var _interopRequireDefault=__webpack_require__(4994);exports.__esModule=true;exports.I18nextContext=void 0;var _react=_interopRequireDefault(__webpack_require__(1799));var I18nextContext=/*#__PURE__*/_react.default.createContext({language:'en',languages:['en'],routed:false,defaultLanguage:'en',generateDefaultLanguagePage:false,originalPath:'/',path:'/'});exports.I18nextContext=I18nextContext;
...
"use strict";
exports.__esModule=true;exports.LANGUAGE_KEY=void 0;var LANGUAGE_KEY='gatsby-i18next-language';exports.LANGUAGE_KEY=LANGUAGE_KEY;
...
const{wrapPageElement}=__webpack_require__(2107);exports.wrapPageElement=wrapPageElement;
...
"use strict";
var React=_interopRequireWildcard(__webpack_require__(1799));var _gatsby=__webpack_require__(123);var _path=__webpack_require__(2003);function _getRequireWildcardCache(nodeInterop){if(typeof WeakMap!=="function")return null;var cacheBabelInterop=new WeakMap();var cacheNodeInterop=new WeakMap();return(_getRequireWildcardCache=function _getRequireWildcardCache(nodeInterop){return nodeInterop?cacheNodeInterop:cacheBabelInterop;})(nodeInterop);}function _interopRequireWildcard(obj,nodeInterop){if(!nodeInterop&&obj&&obj.__esModule){return obj;}if(obj===null||typeof obj!=="object"&&typeof obj!=="function"){return{default:obj};}var cache=_getRequireWildcardCache(nodeInterop);if(cache&&cache.has(obj)){return cache.get(obj);}var newObj={};var hasPropertyDescriptor=Object.defineProperty&&Object.getOwnPropertyDescriptor;for(var key in obj){if(key!=="default"&&Object.prototype.hasOwnProperty.call(obj,key)){var desc=hasPropertyDescriptor?Object.getOwnPropertyDescriptor(obj,key):null;if(desc&&(desc.get||desc.set)){Object.defineProperty(newObj,key,desc);}else{newObj[key]=obj[key];}}}newObj.default=obj;if(cache){cache.set(obj,newObj);}return newObj;}// TODO: Remove for v3 - Fix janky path/asset prefixing
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(1799);
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=__webpack_require__(2460),e=__webpack_require__(1799),k=null,l=0,m=!0;function p(a,b){a=a.write(b);m=m&&a}
...
var React = __webpack_require__(1799);
...
"use strict";
module.exports = require("/Users/johan/CRstudio/CRstudio/.cache/ssr-builtin-trackers/fs");
...
const hasValidReactChildren = children => Array.isArray(children) && children.every(index_js_.isValidElement);
...
const renderNodes = (children, targetString, i18n, i18nOptions, combinedTOpts, shouldUnescape) => {
  ...
  const getData = childs => {
    ...
    childrenArray.forEach(child => {
      ...
      if (hasChildren(child)) getData(getChildren(child));else if (isObject(child) && !(0,index_js_.isValidElement)(child)) Object.assign(data, child);
    });
  };
  getData(children);
  ...
  const pushTranslatedJSX = (child, inner, mem, i, isVoid) => {
    if (child.dummy) {
      ...
      mem.push((0,index_js_.cloneElement)(child, {
        key: i
      }, isVoid ? undefined : inner));
    } else {
      mem.push(...index_js_.Children.map([child], c => {
        const props = {
          ...c.props
        };
        delete props.i18nIsDynamicList;
        return (0,index_js_.createElement)(c.type, {
          ...props,
          key: i,
          ref: c.ref
        }, isVoid ? null : inner);
  ...
  const mapAST = (reactNode, astNode, rootReactNode) => {
    ...
    return astNodes.reduce((mem, node, i) => {
      ...
      if (node.type === 'tag') {
        ...
        const isElement = (0,index_js_.isValidElement)(child);
...
const fixComponentProps = (component, index, translation) => {
  ...
  const comp = (0,index_js_.cloneElement)(component, {
    key: componentKey
  });
  ...
  function Componentized() {
    return (0,index_js_.createElement)(index_js_.Fragment, null, comp);
  }
  return (0,index_js_.createElement)(Componentized);
};
...
const I18nContext = (0,index_js_.createContext)();
...
function Trans_Trans({
  ...
  } = (0,index_js_.useContext)(I18nContext) || {};
...
const useMemoizedT = (i18n, language, namespace, keyPrefix) => (0,index_js_.useCallback)(alwaysNewT(i18n, language, namespace, keyPrefix), [i18n, language, namespace, keyPrefix]);
const useTranslation = (ns, props = {}) => {
  ...
  const [t, setT] = (0,index_js_.useState)(getT);
  let joinedNS = namespaces.join();
  if (props.lng) joinedNS = `${props.lng}${joinedNS}`;
  const previousJoinedNS = usePrevious(joinedNS);
  const isMounted = (0,index_js_.useRef)(true);
  (0,index_js_.useEffect)(() => {
    const {
      bindI18n,
      bindI18nStore
...
const withTranslation = (ns, options = {}) => function Extend(WrappedComponent) {
  function I18nextWithTranslation({
    ...
    return (0,index_js_.createElement)(WrappedComponent, passDownProps);
  }
  I18nextWithTranslation.displayName = `withI18nextTranslation(${getDisplayName(WrappedComponent)})`;
  I18nextWithTranslation.WrappedComponent = WrappedComponent;
  const forwardRef = (props, ref) => (0,index_js_.createElement)(I18nextWithTranslation, Object.assign({}, props, {
    forwardedRef: ref
  }));
  return options.withRef ? (0,index_js_.forwardRef)(forwardRef) : I18nextWithTranslation;
};
...
function I18nextProvider({
  ...
  const value = (0,index_js_.useMemo)(() => ({
    i18n,
    defaultNS
  }), [i18n, defaultNS]);
  return (0,index_js_.createElement)(I18nContext.Provider, {
    value
  }, children);
}
...
const withSSR = () => function Extend(WrappedComponent) {
  function I18nextWithSSR({
    ...
    return (0,index_js_.createElement)(WrappedComponent, {
      ...rest
    });
  }
...
const React=__webpack_require__(1799);const path=__webpack_require__(2003);const{renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(8279);const{ServerLocation,Router,isRedirect}=__webpack_require__(6462);const merge=__webpack_require__(4744);const{StaticQueryContext}=__webpack_require__(123);const fs=__webpack_require__(1078);const{WritableAsPromise}=__webpack_require__(5297);const{RouteAnnouncerProps}=__webpack_require__(6858);const{apiRunner,apiRunnerAsync}=__webpack_require__(9432);const asyncRequires=__webpack_require__(6877);const{version:gatsbyVersion}=__webpack_require__(5818);const{grabMatchParams}=__webpack_require__(5870);const{headHandlerForSSR}=__webpack_require__(988);const{SlicesResultsContext,SlicesContext,SlicesMapContext,SlicesPropsContext}=__webpack_require__(2024);const{ServerSliceRenderer}=__webpack_require__(8455);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
