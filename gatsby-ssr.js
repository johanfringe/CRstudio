...
exports.onRenderBody = ({ pathname, setHtmlAttributes, setHeadComponents }) => {
    ...
    if (process.env.NODE_ENV !== "production" && !supportedLangs.includes(pathLang) && pathLang !== "") {
        warn("⚠️ Onbekende taal gedetecteerd in URL, fallback gebruikt.", { pathLang, fallbackLang: i18nConfig.fallbackLng });
      }
